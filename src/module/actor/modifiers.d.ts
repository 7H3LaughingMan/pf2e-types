...
import { DamageCategoryUnique, DamageDiceFaces, DamageDieSize, DamageType } from "#system/damage/types.js";
...
declare const MODIFIER_TYPES: Set<"item" | "untyped" | "status" | "ability" | "proficiency" | "potency" | "circumstance">;
