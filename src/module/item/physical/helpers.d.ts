...
import { ArmorSource, PhysicalItemSource, ShieldSource, WeaponSource } from "#item/base/data/index.js";
import { ContainerBulkData } from "#item/container/data.js";
 ...
 */
declare function transferCredits({ item, targetActor, quantity }: { item: PhysicalItemPF2e; targetActor: ActorPF2e; quantity: number }): Promise<void>;
export {
