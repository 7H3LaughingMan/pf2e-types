...
import { BaseItemSourcePF2e, ItemSystemData, ItemSystemSource, ItemTraits } from "#item/base/data/system.js";
import { EffectAreaShape } from "#item/types.js";
import { OneToTen, ValueAndMax, ZeroToThree } from "#module/data.js";
import { DamageCategoryUnique, DamageKind, DamageType, MaterialDamageEffect } from "#system/damage/index.js";
import { MagicTradition, SpellTrait } from "./types.js";
