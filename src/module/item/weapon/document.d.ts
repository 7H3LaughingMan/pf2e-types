...
import { AmmoPF2e, MeleePF2e, PhysicalItemPF2e, ShieldPF2e } from "#item";
import { ItemSourcePF2e, RawItemChatData } from "#item/base/data/index.js";
import { NPCAttackTrait } from "#item/melee/types.js";
import { PhysicalItemConstructionContext } from "#item/physical/document.js";
import { IdentificationStatus, MystifiedData } from "#item/physical/index.js";
import { RangeData } from "#item/types.js";
import { StrikeRuleElement } from "#module/rules/rule-element/strike.js";
import { EnrichmentOptionsPF2e } from "#system/text-editor.js";
import { WeaponDamage, WeaponFlags, WeaponSource, WeaponSystemData } from "./data.js";
import { BaseWeaponType, OtherWeaponTag, WeaponCategory, WeaponGroup, WeaponReloadTime, WeaponTrait } from "./types.js";
