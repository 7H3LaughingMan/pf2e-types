...
import { DurationDataSchema, EffectAuraData, EffectContextField } from "#item/abstract-effect/data.js";
import { AbstractEffectSchema } from "#item/abstract-effect/index.js";
import { EffectTrait, TimeUnit } from "#item/abstract-effect/types.js";
import { ItemSystemModel } from "#item/base/data/model.js";
import { BaseItemSourcePF2e, ItemFlagsPF2e, ItemSourceFlagsPF2e, ItemSystemSource, ItemTraitsNoRarity } from "#item/base/data/system.js";
import { ConditionSlug } from "#item/condition/index.js";
import { DamageCategoryUnique, DamageType } from "#system/damage/types.js";
import { AfflictionPF2e } from "./document.js";
