...
import { AutomaticBonusProgression as ABP } from "#actor/character/automatic-bonus-progression.js";
...
import { WorldClock } from "#module/apps/world-clock/app.js";
import { CanvasPF2e, EffectsCanvasGroupPF2e } from "#module/canvas/index.js";
import { StatusEffects } from "#module/canvas/status-effects.js";
...
import {
    ...
    stealthForSelected,
    xpFromEncounter,
} from "#scripts/macros/index.js";
import { remigrate } from "#scripts/system/remigrate.js";
import { Check } from "#system/check/index.js";
import { ConditionManager } from "#system/conditions/manager.js";
import { EffectTracker } from "#system/effect-tracker.js";
import { ModuleArt } from "#system/module-art.js";
import { Predicate } from "#system/predication.js";
import { CustomDamageData, HomebrewTag, HomebrewTraitSettingsKey, LanguageSettings } from "#system/settings/homebrew/index.js";
import { WorldClockSettingData } from "#system/settings/world-clock.js";
import { TextEditorPF2e } from "#system/text-editor.js";
